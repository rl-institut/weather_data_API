...
# weather_data_api/
APPS_DIR = BASE_DIR / "weather_data_api"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "weather_data_api.contrib.sites.migrations"}
...
ADMINS = [("""Pierre-Francois Duc""", "pierre-francois-duc@example.com")]
